...
💭 **انا بوت استطيع تشغيل الموسيقى والفيديو في محادثتك الصوتية**

💡 تعلم طريقة تشغيلي واوامر التحكم بي عن طريق  » 📚 الاوامر !

🔖 لتعلم طريقة تشغيلي بمجموعتك اضغط على » ❓طريقة التفعيل !
""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "• نـصـب بـوتك مـن هـنا •", url="https://t.me/muisc_Tepthone",
                    )
                ],
